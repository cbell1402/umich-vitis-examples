...
const int MAX_ITER = 10; // This is the most number of neighbor relations needed to get from one cell to another. 
// Not sure the exact number so this is a placeholder.
...
#pragma HLS PIPELINE II=1
            ...
            newLabels[cell] = smallest;
            if (smallest != labels[cell]) {
                changed = true;
            }
        }
